...
- If you still find the staple pin too **"fiddly"** even after sharpening it, then **learn how to steady your hands ([see article here](https://www.wikihow.com/Improve-Hand-Steadiness))**. Else, you may need to seriously reconsider watchmaking as a hobby. Other movement parts such as hairsprings and jewel clips are far smaller/harder to work with compared to the staple pin, and will pose an immediate roadblock in your journey.
